...
@section('content')
    ...
    <div class="pc-container">
        <div class="pc-content">
            ...
            <!-- [ breadcrumb ] end -->
            <!-- [ Main Content ] start -->
            <h5>Welcome, {{ $admin->nama }}!</h5>

            <div class="row">
                <div class="col-md-6 col-xl-3">
                    <div class="card border-0 shadow-sm rounded-lg">
                        <div class="card-body p-4 text-center">
                            <h6 class="mb-2 text-muted f-w-400">Total Member</h6>
                            <h3 class="mb-3 fw-bold">{{ $totalUsers }}</h3>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card border-0 shadow-sm rounded-lg">
                        <div class="card-body p-4 text-center">
                            <h6 class="mb-2 text-muted f-w-400">Total Produk</h6>
                            <h3 class="mb-3 fw-bold">{{ $totalProduk }}</h3>
                            <div class="border-top pt-2">
                                <small class="text-muted">Updated: {{ \Carbon\Carbon::now()->format('M d, Y') }}</small>
                            </div>
                        </div>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card border-0 shadow-sm rounded-lg">
                        <div class="card-body p-4 text-center">
                            <h6 class="mb-2 text-muted f-w-400">Total Stok Produk Tersedia</h6>
                            <h3 class="mb-3 fw-bold">{{ $totalStokTersedia }}</h3>
                            <div class="border-top pt-2">
                                <small class="text-muted">Updated: {{ \Carbon\Carbon::now()->format('M d, Y') }}</small>
                            </div>
                        </div>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card border-0 shadow-sm rounded-lg">
                        <div class="card-body p-4 text-center">
                            <h6 class="mb-2 text-muted f-w-400">Total Penjualan</h6>
